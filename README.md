...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/requests-ecp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9107&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/requests-ecp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `requests-ecp` can be installed with:

```
conda install requests-ecp
```

It is possible to list all of the versions of `requests-ecp` available on your platform with:
